...
// Fetch memory value
uint8_t get_mem(uint32_t addr) {
  return memory[addr];
}

// Store memory value
void set_mem(uint32_t addr, uint8_t value) {
  memory[addr] = value;
}
...
void opcode_sto(const std::string & dst,
  const std::string & val) {
  set_mem(parse_operand(dst), parse_operand(val));
}
...
void opcode_add(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) + get_mem(parse_operand(src2)));
}
void opcode_adda(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) + parse_operand(val));
}
void opcode_addb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val) + get_mem(parse_operand(src1)));
}
void opcode_addc(const std::string & val1,
  const std::string & val2,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val1) + parse_operand(val2));
}

void opcode_sub(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) - get_mem(parse_operand(src2)));
}
void opcode_suba(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) - parse_operand(val));
}
void opcode_subb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val) - get_mem(parse_operand(src1)));
}
void opcode_subc(const std::string & val1,
  const std::string & val2,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val1) - parse_operand(val2));
}

void opcode_mul(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) * get_mem(parse_operand(src2)));
}
void opcode_mula(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) * parse_operand(val));
}
void opcode_mulb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val) * get_mem(parse_operand(src1)));
}
void opcode_mulc(const std::string & val1,
  const std::string & val2,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val1) * parse_operand(val2));
}

void opcode_div(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) / get_mem(parse_operand(src2)));
}
void opcode_diva(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) / parse_operand(val));
}
void opcode_divb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val) / get_mem(parse_operand(src1)));
}
void opcode_divc(const std::string & val1,
  const std::string & val2,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val1) / parse_operand(val2));
}

void opcode_mod(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) % get_mem(parse_operand(src2)));
}
void opcode_moda(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) % parse_operand(val));
}
void opcode_modb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val) % get_mem(parse_operand(src1)));
}
void opcode_modc(const std::string & val1,
  const std::string & val2,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val1) % parse_operand(val2));
}
...
// Logic operations
void opcode_and(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) & get_mem(parse_operand(src2)));
}
void opcode_anda(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) & parse_operand(val));
}
void opcode_andb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val) & get_mem(parse_operand(src1)));
}
void opcode_not(const std::string & src,
  const std::string & dst) {
  set_mem(parse_operand(dst), ~get_mem(parse_operand(src)));
}
void opcode_nota(const std::string & val,
  const std::string & dst) {
  set_mem(parse_operand(dst), ~parse_operand(val));
}
void opcode_nand(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), ~(get_mem(parse_operand(src1)) & get_mem(parse_operand(src2))));
}
void opcode_nanda(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), ~(get_mem(parse_operand(src1)) & parse_operand(val)));
}
void opcode_nandb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), ~(parse_operand(val) & get_mem(parse_operand(src1))));
}
void opcode_or(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) | get_mem(parse_operand(src2)));
}
void opcode_ora(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) | parse_operand(val));
}
void opcode_orb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val) | get_mem(parse_operand(src1)));
}
void opcode_nor(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), ~(get_mem(parse_operand(src1)) | get_mem(parse_operand(src2))));
}
void opcode_nora(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), ~(get_mem(parse_operand(src1)) | parse_operand(val)));
}
void opcode_norb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), ~(parse_operand(val) | get_mem(parse_operand(src1))));
}
void opcode_xor(const std::string & src1,
  const std::string & src2,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) ^ get_mem(parse_operand(src2)));
}
void opcode_xora(const std::string & src1,
  const std::string & val,
    const std::string & dst) {
  set_mem(parse_operand(dst), get_mem(parse_operand(src1)) ^ parse_operand(val));
}
void opcode_xorb(const std::string & val,
  const std::string & src1,
    const std::string & dst) {
  set_mem(parse_operand(dst), parse_operand(val) ^ get_mem(parse_operand(src1)));
}
...
void opcode_lar(const std::string & src1,
  const std::string & src2) {
  compare_flag = get_mem(parse_operand(src1)) > get_mem(parse_operand(src2));
}
void opcode_lara(const std::string & src1,
  const std::string & val) {
  compare_flag = get_mem(parse_operand(src1)) > parse_operand(val);
}
void opcode_larb(const std::string & val,
  const std::string & src1) {
  compare_flag = parse_operand(val) > get_mem(parse_operand(src1));
}
void opcode_larc(const std::string & val1,
  const std::string & val2) {
  compare_flag = parse_operand(val1) > parse_operand(val2);
}
void opcode_lss(const std::string & src1,
  const std::string & src2) {
  compare_flag = get_mem(parse_operand(src1)) < get_mem(parse_operand(src2));
}
void opcode_lssa(const std::string & src1,
  const std::string & val) {
  compare_flag = get_mem(parse_operand(src1)) < parse_operand(val);
}
void opcode_lssb(const std::string & val,
  const std::string & src1) {
  compare_flag = parse_operand(val) < get_mem(parse_operand(src1));
}
void opcode_lssc(const std::string & val1,
  const std::string & val2) {
  compare_flag = parse_operand(val1) < parse_operand(val2);
}
void opcode_equ(const std::string & src1,
  const std::string & src2) {
  compare_flag = get_mem(parse_operand(src1)) == get_mem(parse_operand(src2));
}
void opcode_equa(const std::string & src1,
  const std::string & val) {
  compare_flag = get_mem(parse_operand(src1)) == parse_operand(val);
}
void opcode_equb(const std::string & val,
  const std::string & src1) {
  compare_flag = parse_operand(val) == get_mem(parse_operand(src1));
}
void opcode_equc(const std::string & val1,
  const std::string & val2) {
  compare_flag = parse_operand(val1) == parse_operand(val2);
}
void opcode_nequ(const std::string & src1,
  const std::string & src2) {
  compare_flag = get_mem(parse_operand(src1)) != get_mem(parse_operand(src2));
}
void opcode_nequa(const std::string & src1,
  const std::string & val) {
  compare_flag = get_mem(parse_operand(src1)) != parse_operand(val);
}
void opcode_nequb(const std::string & val,
  const std::string & src1) {
  compare_flag = parse_operand(val) != get_mem(parse_operand(src1));
}
void opcode_nequc(const std::string & val1,
  const std::string & val2) {
  compare_flag = parse_operand(val1) != parse_operand(val2);
}
void opcode_leq(const std::string & src1,
  const std::string & src2) {
  compare_flag = get_mem(parse_operand(src1)) >= get_mem(parse_operand(src2));
}
void opcode_leqa(const std::string & src1,
  const std::string & val) {
  compare_flag = get_mem(parse_operand(src1)) >= parse_operand(val);
}
void opcode_leqb(const std::string & val,
  const std::string & src1) {
  compare_flag = parse_operand(val) >= get_mem(parse_operand(src1));
}
void opcode_leqc(const std::string & val1,
  const std::string & val2) {
  compare_flag = parse_operand(val1) >= parse_operand(val2);
}
void opcode_lsq(const std::string & src1,
  const std::string & src2) {
  compare_flag = get_mem(parse_operand(src1)) <= get_mem(parse_operand(src2));
}
void opcode_lsqa(const std::string & src1,
  const std::string & val) {
  compare_flag = get_mem(parse_operand(src1)) <= parse_operand(val);
}
void opcode_lsqb(const std::string & val,
  const std::string & src1) {
  compare_flag = parse_operand(val) <= get_mem(parse_operand(src1));
}
void opcode_lsqc(const std::string & val1,
  const std::string & val2) {
  compare_flag = parse_operand(val1) <= parse_operand(val2);
}

// Set compare flag manually (stcmp MEM or stcmpa VAL)
void opcode_stcmp(const std::string & src) {
  compare_flag = (get_mem(parse_operand(src)) != 0);
}
void opcode_stcmpa(const std::string & val) {
  compare_flag = (parse_operand(val) != 0);
}
...
void opcode_out(const std::string & mem) {
  std::cout << static_cast < char > (get_mem(parse_operand(mem)));
}
void opcode_outa(const std::string & val) {
  std::cout << static_cast < char > (parse_operand(val));
}
...
int main(int argc, char* argv[]) {
    ...
    while (instruction_addr < instructions.size()) {
        ...
        else if (opcode == "stcmpa") {
            opcode_stcmpa(args[0]);
            instruction_addr += 1;
        }
        else if (opcode == "inp") {
            opcode_inp(args[0]);
